...
const FirstBlock = () => {
    return (
        <div className='mt-4'>
            <h3 className='text-[18px] font-bold'>Agregar Paciente</h3>
            <p className='text-[13px] text-gray-150 mt-4'>Busca el DNI del dueño de la mascota para poder agregar un nuevo paciente</p>
